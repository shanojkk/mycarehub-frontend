...
mixin _$SecurityQuestionsData {
  @JsonKey(name: 'getSecurityQuestions')
  List<SecurityQuestion> get securityQuestionsData =>
...
abstract class $SecurityQuestionsDataCopyWith<$Res> {
  ...
  $Res call(
      {@JsonKey(name: 'getSecurityQuestions')
          List<SecurityQuestion> securityQuestionsData});
}
...
class _$SecurityQuestionsDataCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? securityQuestionsData = freezed,
  }) {
    return _then(_value.copyWith(
      securityQuestionsData: securityQuestionsData == freezed
          ? _value.securityQuestionsData
          : securityQuestionsData // ignore: cast_nullable_to_non_nullable
...
class _$_SecurityQuestionsData implements _SecurityQuestionsData {
  _$_SecurityQuestionsData(
      {@JsonKey(name: 'getSecurityQuestions')
          required this.securityQuestionsData});
  ...
  @override
  @JsonKey(name: 'getSecurityQuestions')
  final List<SecurityQuestion> securityQuestionsData;

  @override
  String toString() {
    return 'SecurityQuestionsData(securityQuestionsData: $securityQuestionsData)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _SecurityQuestionsData &&
            (identical(other.securityQuestionsData, securityQuestionsData) ||
                const DeepCollectionEquality().equals(
                    other.securityQuestionsData, securityQuestionsData)));
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^
      const DeepCollectionEquality().hash(securityQuestionsData);
