...
// in pro_health_360/test/widgets_tests/application/core/custom_client_test.dart.
...
class MockRequest extends _i1.Mock implements _i4.Request {
  ...
  Uri get url => (super.noSuchMethod(Invocation.getter(#url),
      returnValue: _FakeUri_1(this, Invocation.getter(#url))) as Uri);
  @override
  ...
  _i3.ByteStream finalize() => (super.noSuchMethod(
          ...
          returnValue:
              _FakeByteStream_2(this, Invocation.method(#finalize, [])))
      as _i3.ByteStream);
  @override
  _i6.Future<_i4.StreamedResponse> send() =>
      (super.noSuchMethod(Invocation.method(#send, []),
              returnValue: _i6.Future<_i4.StreamedResponse>.value(
                  _FakeStreamedResponse_3(this, Invocation.method(#send, []))))
