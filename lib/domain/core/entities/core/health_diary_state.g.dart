...
_$_HealthDiaryState _$_$_HealthDiaryStateFromJson(Map<String, dynamic> json) {
  return _$_HealthDiaryState(
...
Map<String, dynamic> _$_$_HealthDiaryStateToJson(
        _$_HealthDiaryState instance) =>
    <String, dynamic>{
