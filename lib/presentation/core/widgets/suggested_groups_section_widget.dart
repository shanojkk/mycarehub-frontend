...
class SuggestedGroupsSection extends StatelessWidget {
  ...
  const SuggestedGroupsSection({
    Key? key, required this.suggestedGroups,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                final String title = suggestedGroups.elementAt(index)['title'].toString();
                final String totalMembers = suggestedGroups.elementAt(index)['totalMembers'].toString();
                final String iconUrl =
                    suggestedGroups.elementAt(index)['iconUrl'].toString();
                return Column(
                  children: <Widget>[
                    SuggestedGroupCard(groupIconUrl: iconUrl,groupTitle: title, groupTotalMembers: totalMembers)
                  ],
                );
              },
            ),
